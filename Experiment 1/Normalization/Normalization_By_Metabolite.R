...
df_Hpos_norm[, 6:ncol(df_Hpos_norm)] <- scale(
  df_Hpos_norm[, 6:ncol(df_Hpos_norm)],
  center = TRUE,
  scale = FALSE
)
...
df_Hneg_norm[, 6:ncol(df_Hneg_norm)] <- scale(
  df_Hneg_norm[, 6:ncol(df_Hneg_norm)],
  center = TRUE,
  scale = FALSE
)
...
df_C18neg_norm[, 6:ncol(df_C18neg_norm)] <- scale(
  df_C18neg_norm[, 6:ncol(df_C18neg_norm)],
  center = TRUE,
  scale = FALSE
)
...
df_C18pos_norm[, 6:ncol(df_C18pos_norm)] <- scale(
  df_C18pos_norm[, 6:ncol(df_C18pos_norm)],
  center = TRUE,
  scale = FALSE
)
